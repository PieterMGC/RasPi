...
cv2.createTrackbar('hue_low','My trackbars',10,255,TrackHL)
cv2.createTrackbar('hue_high','My trackbars',10,255,TrackHH)
cv2.createTrackbar('sat_low','My trackbars',100,255,TrackSL)
cv2.createTrackbar('sat_high','My trackbars',100,255,TrackSH)
cv2.createTrackbar('value_low','My trackbars',100,255,TrackVL)
cv2.createTrackbar('value_high','My trackbars',100,255,TrackVH)
